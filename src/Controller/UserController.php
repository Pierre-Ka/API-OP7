...
class UserController extends AbstractController
{
    ...
    public function list(Request $request, UserRepository $userRepository, NormalizerInterface $normalizer, UrlGeneratorInterface $router): JsonResponse
    {
        ...
        $displayer = $data->create($page, $pageCount, $usersCount, $users);
        return $this->json($displayer, JsonResponse::HTTP_OK, [], ['groups' => 'list_user']);
    }
